    ...
    try:
        with open(file_path, 'rb') as f:
            ...
            async with session.post(url, data=data) as response:
                ...
                print(f"{file_path}: [{response.status}] {text[:100]}...")  # print first 100 chars of response
...
if __name__ == "__main__":
    ...
    parser.add_argument("url", help="Target server URL (e.g. https://example.com/upload)")
